...
dependencies {
     ...
     */
    implementation("com.github.database-rider:rider-core:1.37.1")
    implementation("com.github.database-rider:rider-spring:1.37.1")
    testImplementation("com.github.database-rider:rider-junit5:1.37.1")
}
